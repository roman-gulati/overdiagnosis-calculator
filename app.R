                   ...
                   fluidRow(
                            box(width=12,
                                ...
                                p('In the',
                                  ...
                                  'equal numbers of individuals are randomized to a screen or control arm. Latent disease onset occurs at a constant rate. The preclinical duration follows a uniform distribution. The control arm receives no screen tests, so control arm incidence matches latent onset in this arm. The screen arm begins screening in year 1. The empirical difference between screen and control arm incidence can provide an unbiased estimate of the number of overdiagnoses cases under 2 conditions. (1) The difference is based on', em('cumulative incidence'), 'if the screen arm stops screening and on', em('annual incidence'), 'if the screen arm continues screening. (2) The difference is calculated after screening stabilizes plus the maximum preclinical duration.')),
                            column(width=4,
                                   box(width=NULL,
                   ...
                   fluidRow(
                            box(width=12,
                                ...
                                p('In the',
                                  ...
                                  'latent disease onset occurs at a constant rate and the preclinical duration follows a uniform distribution. Initially, before screening starts, the model projects disease incidence in steady state, so that diagnosis without screening matches latent onset in the population. Annual screening begins in segments of the population at specified starting years. The empirical difference between annual incidence with and without screening provides an unbiased estimate of overdiagnosis after screening stabilizes plus the maximum preclinical duration.')),
                            column(width=4,
                                   box(width=NULL,
                                       title='Input parameters',
                                       solidHeader=TRUE,
...
server <- function(input, output){
    ...
    tset <- reactive({
        dset <- trial_setting(arm.size=input$trial.size,
                              ...
                              attendance=input$trial.attendance,
